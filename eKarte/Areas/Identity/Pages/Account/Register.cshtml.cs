...
namespace eKarte.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(100, ErrorMessage = "{0} mora biti minimalno {2} i maksimalno {1} characters long.", MinimumLength = 6)]
            ...
            [Compare("Password", ErrorMessage = "Lozinke moraju biti identične")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    if (!await _roleManager.RoleExistsAsync(StaticData.User))// Dodaju se nove dvije role u bazu
                    {
